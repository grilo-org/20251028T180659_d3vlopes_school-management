...
class AdminUpdateMapper
  implements IMapper<AdminModel, AdminUpdateResponseDTO>
{
  toDTO(model: AdminModel): AdminUpdateResponseDTO {
    return {
      id: model.id,
      name: model.name,
      email: model.email,
...
export const adminUpdateMapper = new AdminUpdateMapper()
